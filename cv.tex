...
\cvdoubleitem{FAUST}{Intermédiaire}{Quarto}{Intermédiaire}
\cvdoubleitem{C++}{Débutant}{Python}{Débutant}
\section{Centres d'intérêts}
\cvitem{Hobby}{Guitariste, chanteur et compositeur du groupe Outwards}
